...
if ($background['SHOW_BACKGROUND_COLOR'] == 1) {
   ?> style="background-color:<?php echo $background['BACKGROUND_COLOR'] ?>" <?php } ?>>
    ...
    <div>
        ...
        <div><?php echo $form->labelEx($model, 'content'); ?></div><div><?php echo $form->textArea($model, 'notice', array('cols' => 30, 'rows' => 10, 'style' => "overflow:auto")); ?></div>
    </div>
    <div width="90%">
        <div>
...
<script type="text/javascript">
    window.EditNotice = {
        previewData:function() {
            ...
            document.getElementById('contentPreview').innerHTML = document.getElementById('EditNotceForm_contentEdit').value;
        },
        resetData:function() {
