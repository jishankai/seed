<?php
/**
 * ApurifanCodeModule is the module class to support famitsu code campaign.
 */

class ApurifanCodeModule extends CWebModule
{
    /**
     ...
     * This property can be configured in configure file.
     */
    public $maxCodesPerUser = 1;

    /**
     * @var The class which represent user of apurifanCode. It should implement interface IFamitsuUser.
     * This property can be configured in configure file.
     */
    public $userClass;
